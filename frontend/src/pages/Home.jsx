        ...
        <div className="container split">
          ...
          <ol className="steps">
            <li>
              ...
              Аудит, легализация, приглашение и страхование рисков.
            </li>
            <li>
              <strong>Международная логистика</strong>
              Стандартный или мультимодальный маршрут и обеспечение в пути.
            </li>
            <li>
              <strong>Сопровождение в РФ</strong>
              Жильё, миграция, язык, экипировка и консьерж.
            </li>
          </ol>
        </div>
      </section>
