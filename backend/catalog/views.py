...
SITE = {
    "name": "Рекрут",
    "letter": "Р",
    "tagline": "Международный подбор персонала под ключ",
    "description": (
        "Кадровое агентство «Рекрут» закрывает вакансии квалифицированными "
...
RULES = """
Правила пользования сайтом кадрового агентства «Рекрут»
...
OFFER = """
Публичная оферта на оказание услуг кадрового агентства «Рекрут»
